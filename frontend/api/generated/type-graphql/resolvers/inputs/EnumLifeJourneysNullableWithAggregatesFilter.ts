...
import { NestedEnumLifeJourneysNullableWithAggregatesFilter } from "../inputs/NestedEnumLifeJourneysNullableWithAggregatesFilter";
import { NestedIntNullableFilter } from "../inputs/NestedIntNullableFilter";
import { LifeJourneys } from "../../enums/LifeJourneys";

@TypeGraphQL.InputType("EnumLifeJourneysNullableWithAggregatesFilter", {
  isAbstract: true
})
export class EnumLifeJourneysNullableWithAggregatesFilter {
