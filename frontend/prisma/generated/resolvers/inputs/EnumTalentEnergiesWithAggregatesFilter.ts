...
import { NestedEnumTalentEnergiesWithAggregatesFilter } from "../inputs/NestedEnumTalentEnergiesWithAggregatesFilter";
import { NestedIntFilter } from "../inputs/NestedIntFilter";
import { TalentEnergies } from "../../enums/TalentEnergies";

@TypeGraphQL.InputType("EnumTalentEnergiesWithAggregatesFilter", {
  isAbstract: true
})
export class EnumTalentEnergiesWithAggregatesFilter {
