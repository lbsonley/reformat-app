...
import { NestedEnumArchetypesNullableWithAggregatesFilter } from "../inputs/NestedEnumArchetypesNullableWithAggregatesFilter";
import { NestedIntNullableFilter } from "../inputs/NestedIntNullableFilter";
import { Archetypes } from "../../enums/Archetypes";

@TypeGraphQL.InputType("EnumArchetypesNullableWithAggregatesFilter", {
  isAbstract: true
})
export class EnumArchetypesNullableWithAggregatesFilter {
